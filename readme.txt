...
Usage: trfx File -a Match -b Mismatch  -d Delta  -m  PM -i  PI  -s Minscore -p Maxperiod -t thread 
...
For most use cases, default parameters work perfectly:
# Basic usage - just specify input file and threads
./trfx your_sequences.fasta -t 8
...
Project Structure
TRFx/
├── trfx*                 # Main executable
├── Makefile              # Build configuration
├── test/                 # Test directory
│   ├── cmd              # One-click test script
│   ├── input.fasta      # Example data
