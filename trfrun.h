...
//  Result TRF2(bseq1_t *pseq, Result myResult, const trf_opt *opt, readonly_vars_struct *ro_vars)
//  {
...
// 	 static __thread void *persistent_buffer = NULL;        // 线程局部内存池
// 	 static __thread size_t last_buffer_size = 0;           // 上次分配的大小
// 	 void *base_ptr = NULL;
// 	 int **S = NULL;
// 	 unsigned int i;
// 	 Result ret = myResult;
...
// 	 // 内存重用逻辑
// 	 if (persistent_buffer && total_bytes <= last_buffer_size) {
// 		 base_ptr = persistent_buffer;
// 	 } else {
// 		 if (persistent_buffer) {
// 			 free(persistent_buffer);
// 			 persistent_buffer = NULL;
// 		 }
// 		 if (posix_memalign(&persistent_buffer, 64, total_bytes) != 0) {
// 			 char errmsg[255];
